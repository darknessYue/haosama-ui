...
import { useId } from "@haosama-ui/hooks";
import { FORM_CTX_KEY, FORM_ITEM_CTX_KEY } from "./constants";

defineOptions({ name: "HrFormItem" });
...
<template>
  ...
  >
    ...
    <div class="hr-form-item__content">
      <slot :validate="validate"></slot>
      <div class="hr-form-item__error-msg" v-if="validateStatus === 'error'">
