...
// import { debugWarn } from "@haosama-ui/utils";
import { COLLAPSE_CTX_KEY } from "./constants";

const COMPONENT_NAME = "HrCollapse" as const;
...
if (props.accordion && activeNames.value.length > 1) {
  console.warn(COMPONENT_NAME, "accordion mode should only have one active item");
}
