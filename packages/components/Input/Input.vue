...
import { useFocusController } from "@haosama-ui/hooks";
...
<template>
  ...
  >
    ...
    <template v-if="type !== 'textarea'">
      <!-- prepend slot -->
      <div v-if="$slots.prepend" class="hr-input__prepend">
        <slot name="prepend"></slot>
      </div>
      <div class="hr-input__wrapper" ref="wrapperRef">
        <!-- prefix slot -->
        <span v-if="$slots.prefix" class="hr-input__prefix">
          <slot name="prefix"></slot>
        </span>
        <input
          class="hr-input__inner"
          ref="inputRef"
          :id="inputId"
        ...
        <span
          ...
          class="hr-input__suffix"
        >
          <slot name="suffix"></slot>
          <Icon
            icon="circle-xmark"
            v-if="showClear"
            class="hr-input__clear"
            @click="clear"
      ...
      <!-- append slot -->
      <div v-if="$slots.append" class="hr-input__append">
